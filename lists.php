...
<body id="co_app_body" data-co-app-header-fixed="true" data-co-app-header-fixed-mobile="true"
	data-co-app-sidebar-enabled="true" data-co-app-sidebar-fixed="true" data-co-app-sidebar-push-toolbar="true"
	data-co-app-sidebar-push-footer="true" data-co-app-toolbar-enabled="true" data-co-app-aside-enabled="true"
	data-co-app-aside-fixed="false" class="app-default">
	<script>var defaultThemeMode = "light"; var themeMode; if (document.documentElement) { if (document.documentElement.hasAttribute("data-bs-theme-mode")) { themeMode = document.documentElement.getAttribute("data-bs-theme-mode"); } else { if (localStorage.getItem("data-bs-theme") !== null) { themeMode = localStorage.getItem("data-bs-theme"); } else { themeMode = defaultThemeMode; } } if (themeMode === "system") { themeMode = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"; } document.documentElement.setAttribute("data-bs-theme", themeMode); }</script>
	<div class="d-flex flex-column flex-root app-root" id="co_app_root">
		<div class="app-page flex-column flex-column-fluid" id="co_app_page">
			<div id="co_app_header" class="app-header">
				<div class="app-header-logo d-flex align-items-center ps-lg-10 gap-4 gap-lg-6">
					<button id="co_app_aside_toggle"
						...
						<i class="ci-outline ci-burger-menu-6 fs-3"></i>
					</button>
					<a href="index.html">
				...
				<div class="app-header-wrapper">
					<div class="app-container container-fluid">
						<div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1 me-1 me-lg-0">
							<div id="co_header_search" class="header-search d-flex align-items-center w-lg-400px"
								data-co-search-keypress="true" data-co-search-min-length="2"
								data-co-search-enter="enter" data-co-search-layout="menu" data-co-search-responsive="lg"
								data-co-menu-trigger="auto" data-co-menu-permanent="true"
								data-co-menu-placement="bottom-start">
								<div data-co-search-element="toggle"
									class="search-toggle-mobile d-flex d-lg-none align-items-center">
									<div class="d-flex">
										<i class="ci-outline ci-magnifier fs-1"></i>
									</div>
								</div>
								<form data-co-search-element="form"
									class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
									<input type="hidden" />
									<i
										class="ci-outline ci-magnifier search-icon fs-2 text-gray-500 position-absolute top-50 translate-middle-y ms-5"></i>
									<input type="text" class="search-input form-control form-control rounded-1 ps-13"
										name="search" value="" placeholder="Search..." data-co-search-element="input" />
									<span
										class="search-spinner position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-5"
										data-co-search-element="spinner">
										<span class="spinner-border h-15px w-15px align-middle text-gray-500"></span>
									</span>
									<span
										class="search-reset btn btn-flush btn-active-color-primary position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-4"
										data-co-search-element="clear">
										<i class="ci-outline ci-cross fs-2 fs-lg-1 me-0"></i>
									</span>
								</form>
								<div data-co-search-element="content"
									class="menu menu-sub menu-sub-dropdown py-7 px-7 overflow-hidden w-300px w-md-350px">
									<div data-co-search-element="wrapper">
										<div data-co-search-element="results" class="d-none">
											<div class="scroll-y mh-200px mh-lg-350px">
												<h3 class="fs-5 text-muted m-0 pb-5"
													data-co-search-element="category-title">Users</h3>
												<a href="#"
												...
												<h3 class="fs-5 text-muted m-0 pt-5 pb-5"
													data-co-search-element="category-title">Customers</h3>
												<a href="#"
													class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
												...
												<h3 class="fs-5 text-muted m-0 pt-5 pb-5"
													data-co-search-element="category-title">Projects</h3>
												<a href="#"
													class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i class="ci-outline ci-notepad fs-2 text-primary"></i>
														</span>
													</div>
												...
												<a href="#"
													...
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i class="ci-outline ci-frame fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
												...
												<a href="#"
													...
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i
																class="ci-outline ci-message-text-2 fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
												...
												<a href="#"
													...
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i
																class="ci-outline ci-profile-circle fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
										...
										<div class="" data-co-search-element="main">
											<div class="d-flex flex-stack fw-semibold mb-4">
												<span class="text-muted fs-6 me-2">Recently Searched:</span>
												<div class="d-flex" data-co-search-element="toolbar">
													<div data-co-search-element="preferences-show"
														class="btn btn-icon w-20px btn-sm btn-active-color-primary me-2 data-bs-toggle="
														title="Show search preferences">
														<i class="ci-outline ci-setting-2 fs-2"></i>
													</div>
													<div data-co-search-element="advanced-options-form-show"
														class="btn btn-icon w-20px btn-sm btn-active-color-primary me-n1"
														data-bs-toggle="tooltip" title="Show more search options">
														<i class="ci-outline ci-down fs-2"></i>
													</div>
												</div>
											</div>
											<div class="scroll-y mh-200px mh-lg-325px">
												<div class="d-flex align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i class="ci-outline ci-laptop fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
															class="fs-6 text-gray-800 text-hover-primary fw-semibold">BoomApp</a>
												...
												<div class="d-flex align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i class="ci-outline ci-chart-simple fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i class="ci-outline ci-chart fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i
																class="ci-outline ci-chart-line-down fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i class="ci-outline ci-sms fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center mb-5">
													<div class="symbol symbol-40px me-4">
														<span class="symbol-label bg-light">
															<i class="ci-outline ci-bank fs-2 text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
										...
										<div data-co-search-element="empty" class="text-center d-none">
											<div class="pt-10 pb-10">
												<i class="ci-outline ci-search-list fs-4x opacity-50"></i>
											</div>
									...
									<form data-co-search-element="advanced-options-form" class="pt-1 d-none">
										...
										<div class="mb-5">
											<select name="timezone" aria-label="Select a Timezone"
												data-control="select2" data-dropdown-parent="#co_header_search"
										...
										<div class="d-flex justify-content-end">
											<button type="reset"
												...
												data-co-search-element="advanced-options-form-cancel">Cancel</button>
											<a href="utilities/search/horizontal.html"
												class="btn btn-sm fw-bold btn-primary"
												data-co-search-element="advanced-options-form-search">Search</a>
										</div>
									</form>
									<form data-co-search-element="preferences" class="pt-1 d-none">
										...
										<div class="d-flex justify-content-end pt-7">
											<button type="reset"
												class="btn btn-sm btn-light fw-bold btn-active-light-primary me-2"
												data-co-search-element="preferences-dismiss">Cancel</button>
						...
						<div class="app-navbar flex-shrink-0">
							<div class="app-navbar-item ms-1 ms-lg-3">
								<div class="btn btn-icon w-35px h-35px w-md-40px h-md-40px" id="co_activities_toggle">
									<i class="ci-outline ci-calendar fs-1"></i>
								</div>
							</div>
							<div class="app-navbar-item ms-1 ms-lg-3">
								<div class="btn btn-icon w-35px h-35px w-md-40px h-md-40px"
									data-co-menu-trigger="{default: 'click', lg: 'hover'}" data-co-menu-attach="parent"
									data-co-menu-placement="bottom-end">
									<i class="ci-outline ci-abstract-26 fs-1"></i>
								</div>
								<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
									data-co-menu="true" id="co_menu_notifications">
										...
										<ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
											<li class="nav-item">
												<a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
													data-bs-toggle="tab" href="#co_topbar_notifications_1">Alerts</a>
											</li>
											<li class="nav-item">
												<a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active"
													data-bs-toggle="tab" href="#co_topbar_notifications_2">Updates</a>
											</li>
											<li class="nav-item">
												<a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
													data-bs-toggle="tab" href="#co_topbar_notifications_3">Logs</a>
											</li>
										</ul>
									</div>
									<div class="tab-content">
										<div class="tab-pane fade" id="co_topbar_notifications_1" role="tabpanel">
													...
													<div class="d-flex align-items-center">
														<div class="symbol symbol-35px me-4">
															<span class="symbol-label bg-light-primary">
																<i
																	class="ci-outline ci-abstract-28 fs-2 text-primary"></i>
															</span>
														</div>
														<div class="mb-0 me-2">
															<a href="#"
													...
													<div class="d-flex align-items-center">
														<div class="symbol symbol-35px me-4">
															<span class="symbol-label bg-light-danger">
																<i
																	class="ci-outline ci-information fs-2 text-danger"></i>
															</span>
														</div>
														<div class="mb-0 me-2">
															<a href="#"
													...
													<div class="d-flex align-items-center">
														<div class="symbol symbol-35px me-4">
															<span class="symbol-label bg-light-warning">
																<i
																	class="ci-outline ci-briefcase fs-2 text-warning"></i>
															</span>
														</div>
														<div class="mb-0 me-2">
															<a href="#"
													...
													<div class="d-flex align-items-center">
														<div class="symbol symbol-35px me-4">
															<span class="symbol-label bg-light-success">
																<i
																	class="ci-outline ci-abstract-12 fs-2 text-success"></i>
															</span>
														</div>
														<div class="mb-0 me-2">
															<a href="#"
												...
												<div class="d-flex flex-stack py-4">
													<div class="d-flex align-items-center">
														<div class="symbol symbol-35px me-4">
															<span class="symbol-label bg-light-primary">
																<i
																	class="ci-outline ci-colors-square fs-2 text-primary"></i>
															</span>
														</div>
														<div class="mb-0 me-2">
															<a href="#"
													...
													<div class="d-flex align-items-center">
														<div class="symbol symbol-35px me-4">
															<span class="symbol-label bg-light-info">
																<i class="ci-outline ci-picture fs-2 text-info"></i>
															</span>
														</div>
														<div class="mb-0 me-2">
															<a href="#"
												...
												<div class="d-flex flex-stack py-4">
													<div class="d-flex align-items-center">
														<div class="symbol symbol-35px me-4">
															<span class="symbol-label bg-light-warning">
																<i
																	class="ci-outline ci-color-swatch fs-2 text-warning"></i>
															</span>
														</div>
														<div class="mb-0 me-2">
															<a href="#"
											...
											<div class="py-3 text-center border-top">
												<a href="pages/user-profile/activity.html"
													...
													<i class="ci-outline ci-arrow-right fs-5"></i></a>
											</div>
										</div>
										<div class="tab-pane fade show active" id="co_topbar_notifications_2"
											role="tabpanel">
												...
												<div class="pt-10 pb-0">
													...
													<div class="text-center mt-5 mb-9">
														<a href="#" class="btn btn-sm btn-primary px-6"
															...
															data-bs-target="#co_modal_upgrade_plan">Upgrade</a>
													</div>
												</div>
										...
										<div class="tab-pane fade" id="co_topbar_notifications_3" role="tabpanel">
											<div class="scroll-y mh-325px my-5 px-8">
												<div class="d-flex flex-stack py-4">
							...
							<div class="app-navbar-item ms-1 ms-lg-3">
								<div class="btn btn-icon w-35px h-35px w-md-40px h-md-40px"
									data-co-menu-trigger="{default: 'click', lg: 'hover'}" data-co-menu-attach="parent"
									data-co-menu-placement="bottom-end">
									<i class="ci-outline ci-notification-status fs-1"></i>
									<div
										...
										<div class="card-header">
											...
											<div class="card-toolbar">
												<button type="button"
													...
													data-co-menu-trigger="{default: 'click', lg: 'hover'}"
													data-co-menu-placement="bottom-end">
													<i class="ci-outline ci-setting-3 fs-2"></i>
												</button>
													...
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Create Payment
															<span class="ms-2" data-bs-toggle="tooltip"
																...
																<i class="ci-outline ci-information fs-6"></i>
															</span></a>
													</div>
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3">Generate Bill</a>
													</div>
													<div class="menu-item px-3" data-co-menu-trigger="hover"
														data-co-menu-placement="right-end">
							...
							<div class="app-navbar-item ms-1 ms-lg-3 me-2 me-lg-6" id="co_header_user_menu_toggle">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column">
												...
												<a href="#"
													class="fw-semibold text-muted text-hover-primary fs-7">max@example.com</a>
											</div>
										</div>
									</div>
									<div class="separator my-2"></div>
									...
									<div class="menu-item px-5" data-co-menu-trigger="{default: 'click', lg: 'hover'}"
										data-co-menu-placement="left-start" data-co-menu-offset="-15px, 0">
											...
											<div class="menu-item px-3">
												<a href="account/statements.html"
													...
													<span class="ms-2 lh-0" data-bs-toggle="tooltip"
														...
														<i class="ci-outline ci-information-5 fs-5"></i>
													</span></a>
											</div>
											<div class="separator my-2"></div>
											<div class="menu-item px-3">
										...
										<a href="#" class="menu-link px-5">
											<span class="menu-title position-relative">Mode
												<span class="ms-5 position-absolute translate-middle-y top-50 end-0">
													<i class="ci-outline ci-night-day theme-light-show fs-2"></i>
													<i class="ci-outline ci-moon theme-dark-show fs-2"></i>
												</span></span>
										</a>
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
											data-co-menu="true" data-co-element="theme-mode-menu">
											<div class="menu-item px-3 my-0">
												<a href="#" class="menu-link px-3 py-2" data-co-element="mode"
													data-co-value="light">
													<span class="menu-icon" data-co-element="icon">
														<i class="ci-outline ci-night-day fs-2"></i>
													</span>
											...
											<div class="menu-item px-3 my-0">
												<a href="#" class="menu-link px-3 py-2" data-co-element="mode"
													data-co-value="dark">
													<span class="menu-icon" data-co-element="icon">
														<i class="ci-outline ci-moon fs-2"></i>
													</span>
											...
											<div class="menu-item px-3 my-0">
												<a href="#" class="menu-link px-3 py-2" data-co-element="mode"
													data-co-value="system">
													<span class="menu-icon" data-co-element="icon">
														<i class="ci-outline ci-screen fs-2"></i>
													</span>
			...
			<div class="app-wrapper d-flex" id="co_app_wrapper">
				<div id="co_app_sidebar" class="app-sidebar flex-column" data-co-drawer="true"
					data-co-drawer-name="app-sidebar" data-co-drawer-activate="{default: true, lg: false}"
					data-co-drawer-overlay="true" data-co-drawer-width="auto" data-co-drawer-direction="start"
					data-co-drawer-toggle="#co_app_sidebar_mobile_toggle">
					<div id="co_app_sidebar_wrapper" class="app-sidebar-wrapper hover-scroll-y mx-3 my-2"
						data-co-scroll="true" data-co-scroll-activate="true" data-co-scroll-height="auto"
						data-co-scroll-dependencies="#co_app_sidebar_header" data-co-scroll-offset="5px">
						<div class="alert bg-light-success text-success fw-bold m-5">Sidebar content is empty</div>
					</div>
				</div>
				<div class="app-main flex-column flex-row-fluid" id="co_app_main">
					<div class="d-flex flex-column flex-column-fluid">
						<div id="co_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
							<div id="co_app_toolbar_container"
								class="app-container container-fluid d-flex align-items-stretch">
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										<h1
											class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">
											<?= e($data['page']['heading']) ?></h1>
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										<a href="#"
											...
											data-bs-toggle="modal" data-bs-target="#co_modal_view_users">Add Member</a>
										<a href="#" class="btn btn-flex btn-primary h-40px fs-7 fw-bold"
											data-bs-toggle="modal" data-bs-target="#co_modal_create_campaign">New
											Campaign</a>
									</div>
								</div>
							</div>
						</div>
						<div id="co_app_content" class="app-content">
							<div id="co_app_content_container" class="app-container container-fluid">
								<div class="row g-5 g-xl-8">
										...
										<div class="card card-xl-stretch mb-xl-8">
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-1 fw-semibold fs-7">Pending 10
														tasks</span>
												</h3>
												<div class="card-toolbar">
													<button type="button"
														class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary"
														data-co-menu-trigger="click"
														data-co-menu-placement="bottom-end">
														<i class="ci-outline ci-category fs-6"></i>
													</button>
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
														data-co-menu="true" id="co_menu_68c116d324c99">
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															<div class="mb-10">
																...
																<div>
																	<select class="form-select form-select-solid"
																		multiple="multiple" data-co-select2="true"
																		data-close-on-select="false"
																		data-placeholder="Select option"
																		data-dropdown-parent="#co_menu_68c116d324c99"
															...
															<div class="d-flex justify-content-end">
																<button type="reset"
																	...
																	data-co-menu-dismiss="true">Reset</button>
																<button type="submit" class="btn btn-sm btn-primary"
																	data-co-menu-dismiss="true">Apply</button>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="card-body pt-5">
												<div class="d-flex align-items-center mb-7">
													<div class="symbol symbol-50px me-5">
														<span class="symbol-label bg-light-success">
															<i class="ci-outline ci-abstract-26 fs-2x text-success"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center mb-7">
													<div class="symbol symbol-50px me-5">
														<span class="symbol-label bg-light-warning">
															<i class="ci-outline ci-pencil fs-2x text-warning"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center mb-7">
													<div class="symbol symbol-50px me-5">
														<span class="symbol-label bg-light-primary">
															<i
																class="ci-outline ci-message-text-2 fs-2x text-primary"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center mb-7">
													<div class="symbol symbol-50px me-5">
														<span class="symbol-label bg-light-danger">
															<i class="ci-outline ci-disconnect fs-2x text-danger"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
												...
												<div class="d-flex align-items-center">
													<div class="symbol symbol-50px me-5">
														<span class="symbol-label bg-light-info">
															<i class="ci-outline ci-security-user fs-2x text-info"></i>
														</span>
													</div>
													<div class="d-flex flex-column">
														<a href="#"
									...
									<div class="col-xl-4">
										<div class="card card-xl-stretch mb-xl-8">
											<div class="card-header border-0">
												...
												<div class="card-toolbar">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
														...
														<div class="menu-item px-3" data-co-menu-trigger="hover"
															data-co-menu-placement="right-start">
															<a href="#" class="menu-link px-3">
											...
											<div class="card-body pt-2">
												<?php foreach ($data['authors']['people'] as $person): ?>
													<?= partial('author-card', ['person' => $person]) ?>
												<?php endforeach; ?>
											</div>
										</div>
									</div>
									<div class="col-xl-4">
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-body pt-2">
												<?php foreach ($data['todo']['items'] as $index => $item): ?>
													<?= partial('todo-item', ['item' => $item, 'index' => $index]) ?>
												<?php endforeach; ?>
											</div>
										</div>
									</div>
										...
										<div class="card card-xl-stretch mb-xl-8">
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-1 fw-semibold fs-7">Latest tech
														trends</span>
												</h3>
												<div class="card-toolbar">
													<button type="button"
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<div class="flex-grow-1 me-2">
															<a href="#"
																...
																Authors</a>
															<span class="text-muted fw-semibold d-block fs-7">Mark,
																Rowling, Esther</span>
														</div>
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<div class="flex-grow-1 me-2">
															<a href="#"
																...
																Authors</a>
															<span class="text-muted fw-semibold d-block fs-7">Randy,
																Steve, Mike</span>
														</div>
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<div class="flex-grow-1 me-2">
															<a href="#"
																...
																Theme</a>
															<span class="text-muted fw-semibold d-block fs-7">Disco,
																Retro, Sports</span>
														</div>
										...
										<div class="card card-xl-stretch mb-xl-8">
											<div class="card-header align-items-center border-0 mt-4">
												...
												<div class="card-toolbar">
													...
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
														data-co-menu="true" id="co_menu_68c116d325147">
														<div class="px-7 py-5">
															<div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
														</div>
														<div class="separator border-gray-200"></div>
															...
															<div class="mb-10">
																...
																<div>
																	<select class="form-select form-select-solid"
																		...
																		data-close-on-select="false"
																		data-placeholder="Select option"
																		data-dropdown-parent="#co_menu_68c116d325147"
																		data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-body pt-0">
												<div
													...
													<i class="ci-outline ci-abstract-26 text-warning fs-1 me-5"></i>
													<div class="flex-grow-1 me-2">
														<a href="#"
												...
												<div
													...
													<i class="ci-outline ci-abstract-26 text-success fs-1 me-5"></i>
													<div class="flex-grow-1 me-2">
														<a href="#"
												...
												<div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
													<i class="ci-outline ci-abstract-26 text-danger fs-1 me-5"></i>
													<div class="flex-grow-1 me-2">
														<a href="#"
												...
												<div class="d-flex align-items-center bg-light-info rounded p-5">
													<i class="ci-outline ci-abstract-26 text-info fs-1 me-5"></i>
													<div class="flex-grow-1 me-2">
														<a href="#"
															class="fw-bold text-gray-800 text-hover-primary fs-6">Product
															goals strategy</a>
														<span class="text-muted fw-semibold d-block">Due in 7
															Days</span>
													</div>
										...
										<div class="card card-xl-stretch mb-xl-8">
											<div class="card-header align-items-center border-0 mt-4">
												...
												<div class="card-toolbar">
													...
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
														data-co-menu="true" id="co_menu_68c116d325239">
														<div class="px-7 py-5">
															<div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
														</div>
														<div class="separator border-gray-200"></div>
															...
															<div class="mb-10">
																...
																<div>
																	<select class="form-select form-select-solid"
																		...
																		data-close-on-select="false"
																		data-placeholder="Select option"
																		data-dropdown-parent="#co_menu_68c116d325239"
																		data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
											...
											<div class="card-body pt-3">
													...
													<div
														...
														<div class="flex-grow-1 my-lg-0 my-2 me-2">
															<a href="#"
																class="text-gray-800 fw-bold text-hover-primary fs-6">Cup
																& Green</a>
															<span class="text-muted fw-semibold d-block pt-1">Visually
																stunning</span>
														</div>
														<div class="d-flex align-items-center">
															<div class="me-6">
																<i
																	class="fa fa-star-half-alt me-1 text-warning fs-5"></i>
																<span class="text-gray-800 fw-bold">4.2</span>
															</div>
															<a href="#" class="btn btn-icon btn-light btn-sm border-0">
																<i
																	class="ci-outline ci-arrow-right fs-2 text-primary"></i>
															</a>
														</div>
													</div>
												</div>
												<div class="d-flex align-items-sm-center mb-7">
													...
													<div
														...
														<div class="flex-grow-1 my-lg-0 my-2 me-2">
															<a href="#"
																class="text-gray-800 fw-bold text-hover-primary fs-6">Pink
																Patterns</a>
															<span class="text-muted fw-semibold d-block pt-1">Feminine
																all around</span>
														</div>
														<div class="d-flex align-items-center">
															<div class="me-6">
												...
												<div class="d-flex align-items-sm-center mb-7">
													...
													<div
														...
														<div class="flex-grow-1 my-lg-0 my-2 me-2">
															<a href="#"
																class="text-gray-800 fw-bold text-hover-primary fs-6">Abstract
																Art</a>
															<span class="text-muted fw-semibold d-block pt-1">The will
																to capture readers</span>
														</div>
														<div class="d-flex align-items-center">
															<div class="me-6">
																<i
												...
												<div class="d-flex align-items-sm-center">
													...
													<div
														...
														<div class="flex-grow-1 my-lg-0 my-2 me-2">
															<a href="#"
																class="text-gray-800 fw-bold text-hover-primary fs-6">Desserts
																platter</a>
															<span class="text-muted fw-semibold d-block pt-1">Food
																trends & inspirations</span>
														</div>
														<div class="d-flex align-items-center">
															<div class="me-6">
																<i
											...
											<div class="card-header align-items-center border-0 mt-3">
												...
												<div class="card-toolbar">
													<button type="button"
														...
														data-co-menu-trigger="click"
														data-co-menu-placement="bottom-end">
														<i class="ci-outline ci-category fs-6 text-primary"></i>
													</button>
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
														data-co-menu="true">
														<div class="menu-item px-3">
													...
													<div
														...
														<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
															<a href="#"
																...
																& Green</a>
															<span class="text-gray-500 fw-semibold fs-7 my-1">Study
																highway types</span>
															<span class="text-gray-500 fw-semibold fs-7">By:
																<a href="#"
																	class="text-primary fw-bold">CoreAd</a></span>
														</div>
														<div class="text-end py-lg-0 py-2">
															<span class="text-gray-800 fw-bolder fs-3">24,900</span>
															<span
																class="text-gray-500 fs-7 fw-semibold d-block">Sales</span>
														</div>
													</div>
												</div>
												<div class="d-flex mb-7">
													...
													<div
														...
														<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
															...
															<span class="text-gray-500 fw-semibold fs-7 my-1">Study
																highway types</span>
															<span class="text-gray-500 fw-semibold fs-7">By:
																<a href="#" class="text-primary fw-bold"></a></span>
														</div>
														<div class="text-end py-lg-0 py-2">
													...
													<div
														...
														<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
															<a href="#"
																...
																platter</a>
															<span class="text-gray-500 fw-semibold fs-7 my-1">Food
																trends & reviews</span>
															<span class="text-gray-500 fw-semibold fs-7">By:
																<a href="#" class="text-primary fw-bold">Figma
																	Studio</a></span>
					...
					<div id="co_app_footer" class="app-footer">
						<div
				...
				<div id="co_app_aside" class="app-aside flex-column" data-co-drawer="true"
					data-co-drawer-name="app-aside" data-co-drawer-activate="true" data-co-drawer-overlay="true"
					data-co-drawer-width="auto" data-co-drawer-direction="start"
					data-co-drawer-toggle="#co_app_aside_toggle">
					<div id="co_app_aside_wrapper" class="app-aside-wrapper hover-scroll-y my-4" data-co-scroll="true"
						data-co-scroll-activate="true" data-co-scroll-height="auto" data-co-scroll-offset="5px">
						<div id="co_app_aside_menu"
							class="menu menu-sub-indention menu-rounded menu-column fw-semibold fs-6 px-2"
							data-co-menu="true">
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-element-11 fs-2"></i>
									</span>
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-inner flex-column collapse"
										id="co_app_sidebar_menu_dashboards_collapse">
										<div class="menu-item">
									...
									<div class="menu-item">
										<div class="menu-content">
											<a class="btn btn-flex btn-color-primary d-flex flex-stack fs-base p-0 ms-2 mb-2 toggle collapsible collapsed"
												...
												href="#co_app_sidebar_menu_dashboards_collapse"
												data-co-toggle-text="Show Less">
												<span data-co-toggle-text-target="true">Show 12 More</span>
												<i class="ci-outline ci-minus-square toggle-on fs-2 me-0"></i>
												<i class="ci-outline ci-plus-square toggle-off fs-2 me-0"></i>
											</a>
										</div>
									</div>
								</div>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-address-book fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-element-plus fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-user fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="{default: 'click', lg: 'hover'}"
								data-co-menu-placement="right-start"
								class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-file fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-abstract-39 fs-2"></i>
									</span>
									<span class="menu-title">Social</span>
									<span class="menu-arrow"></span>
								</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-bank fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-chart-pie-3 fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-bucket fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-call fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-color-swatch fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item here show menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-element-7 fs-2"></i>
									</span>
								...
								<div class="menu-sub menu-sub-accordion">
									<div class="menu-item">
										<a class="menu-link active" href="widgets/lists.html">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-abstract-41 fs-2"></i>
									</span>
									<span class="menu-title">Projects</span>
									<span class="menu-arrow"></span>
								</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-basket fs-2"></i>
									</span>
									<span class="menu-title">eCommerce</span>
									<span class="menu-arrow"></span>
								</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-abstract-25 fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-chart fs-2"></i>
									</span>
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div data-co-menu-trigger="click" class="menu-item menu-accordion mb-1">
										<span class="menu-link">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-abstract-28 fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-abstract-38 fs-2"></i>
									</span>
									<span class="menu-title">Customers</span>
									<span class="menu-arrow"></span>
								</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-map fs-2"></i>
									</span>
									<span class="menu-title">Subscription</span>
									<span class="menu-arrow"></span>
								</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-credit-cart fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-switch fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-sms fs-2"></i>
									</span>
							...
							<div data-co-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									<span class="menu-icon">
										<i class="ci-outline ci-message-text-2 fs-2"></i>
									</span>
							...
							<div class="menu-item">
								<a class="menu-link" href="apps/calendar.html">
									<span class="menu-icon">
										<i class="ci-outline ci-calendar-8 fs-2"></i>
									</span>
							...
							<div class="menu-item">
								<a class="menu-link" href="#" target="_blank">
									<span class="menu-icon">
										<i class="ci-outline ci-rocket fs-2"></i>
									</span>
							...
							<div class="menu-item">
								<a class="menu-link" href="#">
									<span class="menu-icon">
										<i class="ci-outline ci-abstract-13 fs-2"></i>
									</span>
							...
							<div class="menu-item">
								<a class="menu-link" href="#" target="_blank">
									<span class="menu-icon">
										<i class="ci-outline ci-abstract-26 fs-2"></i>
									</span>
							...
							<div class="menu-item">
								<a class="menu-link" href="#" target="_blank">
									<span class="menu-icon">
										<i class="ci-outline ci-code fs-2"></i>
									</span>
	...
	<div id="co_activities" class="bg-body" data-co-drawer="true" data-co-drawer-name="activities"
		data-co-drawer-activate="true" data-co-drawer-overlay="true"
		data-co-drawer-width="{default:'300px', 'lg': '900px'}" data-co-drawer-direction="end"
		data-co-drawer-toggle="#co_activities_toggle" data-co-drawer-close="#co_activities_close">
		<div class="card shadow-none border-0 rounded-0">
			<div class="card-header" id="co_activities_header">
				<h3 class="card-title fw-bold text-gray-900">Activity Logs</h3>
				<div class="card-toolbar">
					<button type="button" class="btn btn-sm btn-icon btn-active-light-primary me-n5"
						id="co_activities_close">
						<i class="ci-outline ci-cross fs-1"></i>
					</button>
				</div>
			</div>
			<div class="card-body position-relative" id="co_activities_body">
				<div id="co_activities_scroll" class="position-relative scroll-y me-n5 pe-5" data-co-scroll="true"
					data-co-scroll-height="auto" data-co-scroll-wrappers="#co_activities_body"
					data-co-scroll-dependencies="#co_activities_header, #co_activities_footer"
					data-co-scroll-offset="5px">
					<div class="timeline timeline-border-dashed">
						<div class="timeline-item">
							<div class="timeline-line"></div>
							<div class="timeline-icon">
								<i class="ci-outline ci-message-text-2 fs-2 text-gray-500"></i>
							</div>
						...
						<div class="timeline-item">
							...
							<div class="timeline-icon me-4">
								<i class="ci-outline ci-flag fs-2 text-gray-500"></i>
							</div>
						...
						<div class="timeline-item">
							<div class="timeline-line"></div>
							<div class="timeline-icon">
								<i class="ci-outline ci-disconnect fs-2 text-gray-500"></i>
							</div>
							<div class="timeline-content mb-10 mt-n1">
								<div class="mb-5 pe-3">
						...
						<div class="timeline-item">
							<div class="timeline-line"></div>
							<div class="timeline-icon">
								<i class="ci-outline ci-abstract-26 fs-2 text-gray-500"></i>
							</div>
							<div class="timeline-content mb-10 mt-n1">
								<div class="pe-3 mb-5">
						...
						<div class="timeline-item">
							<div class="timeline-line"></div>
							<div class="timeline-icon">
								<i class="ci-outline ci-pencil fs-2 text-gray-500"></i>
							</div>
							<div class="timeline-content mb-10 mt-n1">
								<div class="pe-3 mb-5">
						...
						<div class="timeline-item">
							<div class="timeline-line"></div>
							<div class="timeline-icon">
								<i class="ci-outline ci-sms fs-2 text-gray-500"></i>
							</div>
							<div class="timeline-content mb-10 mt-n1">
								<div class="pe-3 mb-5">
							...
							<div class="timeline-content mb-10 mt-n1">
								...
								<div class="overflow-auto pb-5">
									<div
										...
										<i class="ci-outline ci-devices-2 fs-2tx text-primary me-4"></i>
						...
						<div class="timeline-item">
							<div class="timeline-line"></div>
							<div class="timeline-icon">
								<i class="ci-outline ci-basket fs-2 text-gray-500"></i>
							</div>
			...
			<div class="card-footer py-5 text-center" id="co_activities_footer">
				<a href="pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View All Activities
					<i class="ci-outline ci-arrow-right fs-3 text-primary"></i></a>
			</div>
		</div>
	</div>
	<div id="co_drawer_chat" class="bg-body" data-co-drawer="true" data-co-drawer-name="chat"
		data-co-drawer-activate="true" data-co-drawer-overlay="true"
		data-co-drawer-width="{default:'300px', 'md': '500px'}" data-co-drawer-direction="end"
		data-co-drawer-toggle="#co_drawer_chat_toggle" data-co-drawer-close="#co_drawer_chat_close">
		<div class="card w-100 border-0 rounded-0" id="co_drawer_chat_messenger">
			<div class="card-header pe-5" id="co_drawer_chat_messenger_header">
				...
				<div class="card-toolbar">
					<div class="me-0">
						<button class="btn btn-sm btn-icon btn-active-color-primary" data-co-menu-trigger="click"
							data-co-menu-placement="bottom-end">
							<i class="ci-outline ci-dots-square fs-2"></i>
						</button>
						<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
							data-co-menu="true">
							<div class="menu-item px-3">
							...
							<div class="menu-item px-3">
								<a href="#" class="menu-link px-3" data-bs-toggle="modal"
									data-bs-target="#co_modal_users_search">Add Contact</a>
							</div>
							<div class="menu-item px-3">
								<a href="#" class="menu-link flex-stack px-3" data-bs-toggle="modal"
									data-bs-target="#co_modal_invite_friends">Invite Contacts
									<span class="ms-2" data-bs-toggle="tooltip"
										title="Specify a contact email to send an invitation">
										<i class="ci-outline ci-information fs-7"></i>
									</span></a>
							</div>
							<div class="menu-item px-3" data-co-menu-trigger="hover"
								data-co-menu-placement="right-start">
					...
					<div class="btn btn-sm btn-icon btn-active-color-primary" id="co_drawer_chat_close">
						<i class="ci-outline ci-cross-square fs-2"></i>
					</div>
				</div>
			</div>
			<div class="card-body" id="co_drawer_chat_messenger_body">
				<div class="scroll-y me-n5 pe-5" data-co-element="messages" data-co-scroll="true"
					data-co-scroll-activate="true" data-co-scroll-height="auto"
					data-co-scroll-dependencies="#co_drawer_chat_messenger_header, #co_drawer_chat_messenger_footer"
					data-co-scroll-wrappers="#co_drawer_chat_messenger_body" data-co-scroll-offset="0px">
					<div class="d-flex justify-content-start mb-10">
						<div class="d-flex flex-column align-items-start">
							...
							<div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
								data-co-element="message-text">How likely are you to recommend our company to your
					...
					<div class="d-flex justify-content-end mb-10">
						<div class="d-flex flex-column align-items-end">
							...
							<div class="p-5 rounded bg-light-primary text-gray-900 fw-semibold mw-lg-400px text-end"
								data-co-element="message-text">Hey there, we’re just writing to let you know that you’ve
					...
					<div class="d-flex justify-content-start mb-10">
						<div class="d-flex flex-column align-items-start">
							...
							<div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
								data-co-element="message-text">Ok, Understood!</div>
						</div>
					</div>
					<div class="d-flex justify-content-end mb-10">
						<div class="d-flex flex-column align-items-end">
							...
							<div class="p-5 rounded bg-light-primary text-gray-900 fw-semibold mw-lg-400px text-end"
								data-co-element="message-text">You’ll receive notifications for all issues, pull
								requests!</div>
						</div>
					</div>
					<div class="d-flex justify-content-start mb-10">
						<div class="d-flex flex-column align-items-start">
							...
							<div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
								data-co-element="message-text">You can unwatch this repository immediately by clicking
								here:
								<a href="#"></a>
							</div>
						</div>
					...
					<div class="d-flex justify-content-end mb-10">
						<div class="d-flex flex-column align-items-end">
							...
							<div class="p-5 rounded bg-light-primary text-gray-900 fw-semibold mw-lg-400px text-end"
								data-co-element="message-text">Most purchased Business courses during this sale!</div>
						</div>
					</div>
					<div class="d-flex justify-content-start mb-10">
						<div class="d-flex flex-column align-items-start">
							...
							<div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
								data-co-element="message-text">Company BBQ to celebrate the last quater achievements and
								goals. Food and drinks provided</div>
						</div>
					</div>
					<div class="d-flex justify-content-end mb-10 d-none" data-co-element="template-out">
						<div class="d-flex flex-column align-items-end">
							<div class="d-flex align-items-center mb-2">
								<div class="me-3">
							...
							<div class="p-5 rounded bg-light-primary text-gray-900 fw-semibold mw-lg-400px text-end"
								data-co-element="message-text"></div>
						</div>
					</div>
					<div class="d-flex justify-content-start mb-10 d-none" data-co-element="template-in">
						<div class="d-flex flex-column align-items-start">
							<div class="d-flex align-items-center mb-2">
								<div class="symbol symbol-35px symbol-circle">
									<img alt="Pic" src="assets/media/avatars/300-25.jpg" />
							...
							<div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
								data-co-element="message-text">Right before vacation season we have the next Big Deal
								for you.</div>
						</div>
					</div>
				</div>
			</div>
			<div class="card-footer pt-4" id="co_drawer_chat_messenger_footer">
				<textarea class="form-control form-control-flush mb-3" rows="1" data-co-element="input"
					placeholder="Type a message"></textarea>
				<div class="d-flex flex-stack">
					<div class="d-flex align-items-center me-2">
						<button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button"
							data-bs-toggle="tooltip" title="Coming soon">
							<i class="ci-outline ci-paper-clip fs-3"></i>
						</button>
						<button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button"
							data-bs-toggle="tooltip" title="Coming soon">
							<i class="ci-outline ci-cloud-add fs-3"></i>
						</button>
					</div>
					<button class="btn btn-primary" type="button" data-co-element="send">Send</button>
				</div>
			</div>
		</div>
	</div>
	<div id="co_shopping_cart" class="bg-body" data-co-drawer="true" data-co-drawer-name="cart"
		data-co-drawer-activate="true" data-co-drawer-overlay="true"
		data-co-drawer-width="{default:'300px', 'md': '500px'}" data-co-drawer-direction="end"
		data-co-drawer-toggle="#co_drawer_shopping_cart_toggle" data-co-drawer-close="#co_drawer_shopping_cart_close">
		<div class="card card-flush w-100 rounded-0">
			<div class="card-header">
				<h3 class="card-title text-gray-900 fw-bold">Shopping Cart</h3>
				<div class="card-toolbar">
					<div class="btn btn-sm btn-icon btn-active-light-primary" id="co_drawer_shopping_cart_close">
						<i class="ci-outline ci-cross fs-2"></i>
					</div>
				</div>
			</div>
					...
					<div class="d-flex flex-column me-3">
						...
						<div class="d-flex align-items-center">
							...
							<a href="#"
								...
								<i class="ci-outline ci-minus fs-4"></i>
							</a>
							<a href="#" class="btn btn-sm btn-light-success btn-icon w-25px h-25px">
								<i class="ci-outline ci-plus fs-4"></i>
							</a>
						</div>
					</div>
	...
	<div id="co_scrolltop" class="scrolltop" data-co-scrolltop="true">
		<i class="ci-outline ci-arrow-up"></i>
	</div>
	<div class="modal fade" id="co_modal_upgrade_plan" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-content rounded">
				...
				<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="row mt-10">
							<div class="col-lg-6 mb-10 mb-lg-0">
								<div class="nav flex-column">
									<label
										...
										data-bs-toggle="tab" data-bs-target="#co_upgrade_plan_startup">
										<div class="d-flex align-items-center me-2">
											<div
										...
										<div class="ms-5">
											...
											<span class="fs-3x fw-bold" data-co-plan-price-month="39"
												data-co-plan-price-annual="399">39</span>
											<span class="fs-7 opacity-50">/
												<span data-co-element="period">Mon</span></span>
										</div>
									</label>
									<label
										...
										data-bs-toggle="tab" data-bs-target="#co_upgrade_plan_advanced">
										<div class="d-flex align-items-center me-2">
											<div
												class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
												<input class="form-check-input" type="radio" name="plan"
										...
										<div class="ms-5">
											<span class="mb-2">$</span>
											<span class="fs-3x fw-bold" data-co-plan-price-month="339"
												data-co-plan-price-annual="3399">339</span>
											<span class="fs-7 opacity-50">/
												<span data-co-element="period">Mon</span></span>
										</div>
									</label>
									<label
										class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
										data-bs-toggle="tab" data-bs-target="#co_upgrade_plan_enterprise">
										<div class="d-flex align-items-center me-2">
											<div
												class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
												<input class="form-check-input" type="radio" name="plan"
										...
										<div class="ms-5">
											<span class="mb-2">$</span>
											<span class="fs-3x fw-bold" data-co-plan-price-month="999"
												data-co-plan-price-annual="9999">999</span>
											<span class="fs-7 opacity-50">/
												<span data-co-element="period">Mon</span></span>
										</div>
									</label>
									<label
										class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
										data-bs-toggle="tab" data-bs-target="#co_upgrade_plan_custom">
										<div class="d-flex align-items-center me-2">
											<div
												class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
												<input class="form-check-input" type="radio" name="plan"
							...
							<div class="col-lg-6">
								<div class="tab-content rounded h-100 bg-light p-10">
									<div class="tab-pane fade show active" id="co_upgrade_plan_startup">
										<div class="pb-5">
										...
										<div class="pt-1">
											<div class="d-flex align-items-center mb-7">
												<span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Up to 10 Active
													Users</span>
												<i class="ci-outline ci-check-circle fs-1 text-success"></i>
											</div>
											<div class="d-flex align-items-center mb-7">
											...
											<div class="d-flex align-items-center mb-7">
												<span class="fw-semibold fs-5 text-muted flex-grow-1">Finance
													Module</span>
												<i class="ci-outline ci-cross-circle fs-1"></i>
											</div>
											<div class="d-flex align-items-center mb-7">
									...
									<div class="tab-pane fade" id="co_upgrade_plan_advanced">
										<div class="pb-5">
											<h2 class="fw-bold text-gray-900">What’s in Startup Plan?</h2>
									...
									<div class="tab-pane fade" id="co_upgrade_plan_enterprise">
										<div class="pb-5">
											<h2 class="fw-bold text-gray-900">What’s in Startup Plan?</h2>
									...
									<div class="tab-pane fade" id="co_upgrade_plan_custom">
										<div class="pb-5">
											<h2 class="fw-bold text-gray-900">What’s in Startup Plan?</h2>
					...
					<div class="d-flex flex-center flex-row-fluid pt-12">
						...
						<button type="submit" class="btn btn-primary" id="co_modal_upgrade_plan_btn">
	...
	<div class="modal fade" id="co_modal_view_users" tabindex="-1" aria-hidden="true">
									...
									<div class="ms-6">
										<a href="#"
											...
											<span class="badge badge-light fs-8 fw-semibold ms-2">Software
												Enginer</span></a>
										<div class="fw-semibold text-muted">max@example.com</div>
									</div>
								</div>
								<div class="d-flex">
									<div class="text-end">
	...
	<div class="modal fade" id="co_modal_create_campaign" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-fullscreen p-9">
			<div class="modal-content modal-rounded">
				...
				<div class="modal-body scroll-y m-5">
					<div class="stepper stepper-links d-flex flex-column" id="co_modal_create_campaign_stepper">
						<div class="stepper-nav justify-content-center py-2">
							<div class="stepper-item me-5 me-md-15 current" data-co-stepper-element="nav">
								<h3 class="stepper-title">Campaign Details</h3>
							</div>
							<div class="stepper-item me-5 me-md-15" data-co-stepper-element="nav">
							...
							<div class="stepper-item" data-co-stepper-element="nav">
								<h3 class="stepper-title">Completed</h3>
							</div>
						</div>
						<form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
							id="co_modal_create_campaign_stepper_form">
							<div class="current" data-co-stepper-element="content">
								<div class="w-100">
									<div class="pb-10 pb-lg-15">
										<h2 class="fw-bold d-flex align-items-center text-gray-900">Setup Campaign
											...
											<span class="ms-1" data-bs-toggle="tooltip"
												...
												<i class="ci-outline ci-information-5 text-gray-500 fs-6"></i>
											</span>
										</h2>
									...
									<div class="fv-row mb-10">
										...
										<div class="image-input image-input-empty image-input-outline image-input-placeholder"
											data-co-image-input="true">
											<div class="image-input-wrapper w-125px h-125px"></div>
											<label
												class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
												data-co-image-input-action="change" data-bs-toggle="tooltip"
												title="Change avatar">
												<i class="ci-outline ci-pencil fs-7"></i>
												<input type="file" name="avatar" accept=".png, .jpg, .jpeg" />
												<input type="hidden" name="avatar_remove" />
											</label>
											<span
												class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
												data-co-image-input-action="cancel" data-bs-toggle="tooltip"
												title="Cancel avatar">
												<i class="ci-outline ci-cross fs-2"></i>
											</span>
											<span
												class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
												data-co-image-input-action="remove" data-bs-toggle="tooltip"
												title="Remove avatar">
												<i class="ci-outline ci-cross fs-2"></i>
											</span>
										</div>
									...
									<div class="mb-10">
										...
										<div class="d-flex fv-row">
											<div class="form-check form-check-custom form-check-solid">
												<input class="form-check-input me-3" name="user_role" type="radio"
													value="0" id="co_modal_update_role_option_0" checked='checked' />
												<label class="form-check-label" for="co_modal_update_role_option_0">
										...
										<div class="d-flex fv-row">
											<div class="form-check form-check-custom form-check-solid">
												<input class="form-check-input me-3" name="user_role" type="radio"
													value="1" id="co_modal_update_role_option_1" />
												<label class="form-check-label" for="co_modal_update_role_option_1">
										...
										<div class="d-flex fv-row">
											<div class="form-check form-check-custom form-check-solid">
												<input class="form-check-input me-3" name="user_role" type="radio"
													value="2" id="co_modal_update_role_option_2" />
												<label class="form-check-label" for="co_modal_update_role_option_2">
										...
										<div class="d-flex fv-row">
											<div class="form-check form-check-custom form-check-solid">
												<input class="form-check-input me-3" name="user_role" type="radio"
													value="3" id="co_modal_update_role_option_3" />
												<label class="form-check-label" for="co_modal_update_role_option_3">
										...
										<div class="d-flex fv-row">
											<div class="form-check form-check-custom form-check-solid">
												<input class="form-check-input me-3" name="user_role" type="radio"
													value="4" id="co_modal_update_role_option_4" />
												<label class="form-check-label" for="co_modal_update_role_option_4">
							...
							<div data-co-stepper-element="content">
								<div class="w-100">
									...
									<div class="fv-row mb-10">
										<div class="dropzone" id="co_modal_create_campaign_files_upload">
											<div class="dz-message needsclick">
												<i class="ci-outline ci-file-up fs-3hx text-primary"></i>
												<div class="ms-4">
							...
							<div data-co-stepper-element="content">
								<div class="w-100">
									...
									<div class="fv-row mb-10">
										...
										<div class="row g-9" data-co-buttons="true"
											data-co-buttons-target="[data-co-button='true']">
											<div class="col">
												<label
									...
									<div class="fv-row mb-10">
										...
										<div class="d-flex flex-stack">
											<div id="co_modal_create_campaign_age_min"
												class="fs-7 fw-semibold text-muted"></div>
											<div id="co_modal_create_campaign_age_slider"
												class="noUi-sm w-100 ms-5 me-8"></div>
											<div id="co_modal_create_campaign_age_max"
												class="fs-7 fw-semibold text-muted"></div>
										</div>
									</div>
									<div class="fv-row mb-10">
										...
										<input class="form-control d-flex align-items-center" value=""
											id="co_modal_create_campaign_location"
											data-co-flags-path="assets/media/flags/" />
									</div>
								</div>
							</div>
							<div data-co-stepper-element="content">
									...
									<div class="fv-row mb-10">
										...
										<div class="d-flex gap-9 mb-7">
											<button type="button"
												...
												id="co_modal_create_campaign_duration_all">Continuous duration
												<br />
											...
											<button type="button"
												...
												id="co_modal_create_campaign_duration_fixed">Fixed duration
												<br />
												<span class="fs-7">Your ad will run on the specified dates
													only.</span></button>
										</div>
										<input class="form-control form-control-solid d-none"
											placeholder="Pick date & time" id="co_modal_create_campaign_datepicker" />
									</div>
									<div class="fv-row mb-10">
										...
										<div class="d-flex flex-column text-center">
											<div class="d-flex align-items-start justify-content-center mb-7">
												...
												<span class="fw-bold fs-3x"
													id="co_modal_create_campaign_budget_label"></span>
												<span class="fw-bold fs-3x">.00</span>
											</div>
											<div id="co_modal_create_campaign_budget_slider" class="noUi-sm"></div>
										</div>
									</div>
								</div>
							</div>
							<div data-co-stepper-element="content">
								<div class="w-100">
									...
									<div class="d-flex flex-center pb-20">
										<button id="co_modal_create_campaign_create_new" type="button"
											class="btn btn-lg btn-light me-3" data-co-element="complete-start">Create
											New Campaign</button>
							...
							<div class="d-flex flex-stack pt-10">
								<div class="me-2">
									<button type="button" class="btn btn-lg btn-light-primary me-3"
										data-co-stepper-action="previous" data-co-stepper-state="hide-on-last-step">
										<i class="ci-outline ci-arrow-left fs-3 me-1"></i>Back</button>
								</div>
								<div>
									<button type="button" class="btn btn-lg btn-primary"
										data-co-stepper-action="submit">
										<span class="indicator-label">Submit
											<i class="ci-outline ci-arrow-right fs-3 ms-2 me-0"></i></span>
										<span class="indicator-progress">Please wait...
											<span
												class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
									</button>
									<button type="button" class="btn btn-lg btn-primary"
										data-co-stepper-action="next">Continue
										<i class="ci-outline ci-arrow-right fs-3 ms-1 me-0"></i></button>
								</div>
							</div>
						</form>
					</div>
	...
	<div class="modal fade" id="co_modal_users_search" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered mw-650px">
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
					...
					<div id="co_modal_users_search_handler" data-co-search-keypress="true" data-co-search-min-length="2"
						data-co-search-enter="enter" data-co-search-layout="inline">
						<form data-co-search-element="form" class="w-100 position-relative mb-5" autocomplete="off">
							<input type="hidden" />
							<i
								class="ci-outline ci-magnifier fs-2 fs-lg-1 text-gray-500 position-absolute top-50 ms-5 translate-middle-y"></i>
							<input type="text" class="form-control form-control-lg form-control-solid px-15"
								name="search" value="" placeholder="Search by username, full name or email..."
								data-co-search-element="input" />
						...
						<div class="py-5">
							<div data-co-search-element="suggestions">
							...
							<div data-co-search-element="results" class="d-none">
								<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='0']"
													value="0" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-6.jpg" />
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="1">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='1']"
													value="1" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<span
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='2']"
													value="2" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-1.jpg" />
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="3">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='3']"
													value="3" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-5.jpg" />
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="4">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='4']"
													value="4" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-25.jpg" />
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="5">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='5']"
													value="5" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<span
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='6']"
													value="6" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-9.jpg" />
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="7">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='7']"
													value="7" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<span
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="8">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='8']"
													value="8" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<span
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='9']"
													value="9" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-23.jpg" />
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="10">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='10']"
													value="10" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<span
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='11']"
													value="11" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-12.jpg" />
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="12">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='12']"
													value="12" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<span class="symbol-label bg-light-info text-info fw-semibold">A</span>
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='13']"
													value="13" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="14">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='14']"
													value="14" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<span
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='15']"
													value="15" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="16">
										<div class="d-flex align-items-center">
											<label class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="checkbox" name="users"
													data-co-check="true" data-co-check-target="[data-user-id='16']"
													value="16" />
											</label>
											<div class="symbol symbol-35px symbol-circle">
												<img alt="Pic" src="assets/media/avatars/300-21.jpg" />
								...
								<div class="d-flex flex-center mt-15">
									<button type="reset" id="co_modal_users_search_reset" data-bs-dismiss="modal"
										class="btn btn-active-light me-3">Cancel</button>
									<button type="submit" id="co_modal_users_search_submit" class="btn btn-primary">Add
	...
	<div class="modal fade" id="co_modal_invite_friends" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog mw-650px">
			<div class="modal-content">
				<div class="modal-header pb-0 border-0 justify-content-end">
					<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
							...
							<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
								...
								<div class="ms-2 w-100px">
									<select class="form-select form-select-solid form-select-sm" data-control="select2"
										data-dropdown-parent="#co_modal_invite_friends" data-hide-search="true">
										<option value="1">Guest</option>
										<option value="2" selected="selected">Owner</option>
										<option value="3">Can Edit</option>
									</select>
